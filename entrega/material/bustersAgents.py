...
class BasicAgentAA(BustersAgent):
    ...
    def printLineData(self, gameState):
        line = ""
        line += "Pacman position: " + str(gameState.getPacmanPosition()) + ","
        line += "Legal actions: " + str(gameState.getLegalPacmanActions()) + ","
        line += "Living ghosts: " + str(gameState.getLivingGhosts()) + ","
        line += "Ghosts positions: " + str(gameState.getGhostPositions()) + ","
        line += "Ghosts distances: " + str(gameState.data.ghostDistances) + "\n"
        f = open("info.txt", "a+")
        f.write(line)
        f.close()
        return line
